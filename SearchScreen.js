    ...
    <View style={styles.container}>
      ...
      <View style={styles.buttonContainer}>
        <View style={styles.columnContainer}>
          ...
          activeOpacity={0.5}>
            <Image source={require('./assets/Icons/fruits-and-vegetables.png')}
                  style={styles.image}
            />
          ...
          <TouchableOpacity onPress={() => navigation.navigate("CreateNewList")} style={styles.button} 
          activeOpacity={0.5}>
            <Image source={require('./assets/Icons/paper-goods.png')}
                  style={styles.image}
            />
          ...
          <TouchableOpacity onPress={() => navigation.navigate("CreateNewList")} style={styles.button} 
          activeOpacity={0.5}>
            <Image source={require('./assets/Icons/chips.png')}
                  style={styles.image}
            />
        ...
        <TouchableOpacity onPress={() => navigation.navigate("CreateNewList")} style={styles.button} 
          activeOpacity={0.5}>
            <Image source={require('./assets/Icons/meat-and-seafood.png')}
                  style={styles.image}
            />
          ...
          <TouchableOpacity onPress={() => navigation.navigate("CreateNewList")} style={styles.button} 
          activeOpacity={0.5}>
            <Image source={require('./assets/Icons/milk-and-cheese.png')}
                  style={styles.image}
            />
          ...
          <TouchableOpacity onPress={() => navigation.navigate("CreateNewList")} style={styles.button} 
          activeOpacity={0.5}>
            <Image source={require('./assets/Icons/bread-and-bakery.png')}
                  style={styles.image}
            />
